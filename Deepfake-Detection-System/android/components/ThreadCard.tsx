...
const ThreadCard = ({ thread: { userId, text, createdAt }, index }: ThreadProps) => {
	return (
		<View className="bg-zinc-900 rounded-2xl overflow-hidden mb-4">
			...
			<ArticleCard
				url="https://www.telegraphindia.com/india/googles-black-ribbon-silence-at-lords-world-buries-itself-in-sorrow-as-india-mourns-ai171/cid/2107690"
				verdict="weakly relevant"
				gemini_analysis={`Relevance Check: ...\nAnalysis: The user submission expresses anger...`}
			/>
		</View>
	);
};
