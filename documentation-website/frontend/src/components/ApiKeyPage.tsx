  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="relative z-10 px-6 py-20 max-w-4xl mx-auto">
        ...
        <p className="text-gray-300 inter-font mb-6">Create a new API key by entering your project name below.</p>
        ...
        <div className="glass-card rounded-xl p-6">
          ...
          {apiKey && (
            <div className="mt-6 text-sm text-gray-300 font-mono relative z-50">
              <span className="text-gray-400">Your API Key:</span>
              <br />
              <code className="text-lime-400 select-all">{apiKey}</code>
            </div>
          )}
        </div>
      </div>
